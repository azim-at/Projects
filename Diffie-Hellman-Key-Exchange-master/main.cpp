...
void credits(){
    ...
    outputGreen(110,650,"S.G. BALEKUNDRI INDTITUTE OF TECHNOLOGY Shivbasava Nagar, Belagavi-590010");
    outputGreen(112,610,"DEPARTMENT OF COMPUTER SCIENCE AND ENGINEERING");



    outputHelveticaWhite(65 ,130," Presented By:");
    outputHelveticaWhite(55,100,"1. Azim Talikoti - 2BU19CS401");
    outputHelveticaWhite(55,75, "2. Anam Mulla - 2BU19CS400");
